...
#
# from src.bot_lib.bot_feature import Button, Feature, FeatureMenu, TgUtils
#
#
# @dataclass
# class Buttons:
...
#     text2='Bot is alive',
# )
# creator_ftr = Feature(commands=['creator'], text='*Master?*')
...
#     text='Отлично, записал. Теперь немного расскажите о себе.', data_key='name'
# )
# set_user_about = Feature(
#     text='Отлично, записал. Теперь скиньте свое фото.', data_key='info'
# )
