...
#     except Exception:
#         logger.warning(
#             f'User with {social_id = } did not receive the message.'
#         )
#
#
# async def bot_safe_delete_message(
#     dp: DbDispatcher, chat_id: int, message_id: int
# ) -> None:
#     try:
#         await dp.bot.delete_message(chat_id, message_id)
#     except Exception:
#         logger.warning(
#             f'Delete message {message_id} from chat {chat_id} failed.'
#         )
#
#
...
#         logger.warning(
#             f'User with {social_id = } did not receive the photo.\nError: {e}'
#         )
#
#
...
#     except Exception as e:
#         logger.warning(
#             f'Cant edit callback message for {callback = }.\nError: {e}'
#         )
